...
exports.random = exports.transposeArray = exports.oneSwap = exports.shuffle = exports.range = exports.sleep = exports.makeGraph = exports.BG_COLOR = exports.CIRC_FILL_RD = exports.CIRC_FILL_BL = void 0;
var d3 = require("d3");
...
function makeGraph(numNodes, expNumEdges, addSelfLoops) {
    if (addSelfLoops === void 0) { addSelfLoops = true; }
    var idxs = range(numNodes);
    ...
    for (var i = 0; i < expNumEdges; i++) {
        var idx = i % numNodes;
        if (addSelfLoops) {
            addNeighbor(idx, idx);
        }
        var neighIdx = Math.floor(exports.random[i] * numNodes);
        if (idx != neighIdx) {
